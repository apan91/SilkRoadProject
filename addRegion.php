			...
			<?php
				...
				if(!isset($_FILES['uploadedfile'])) {
					...
					if(trim($name) == '' || !preg_match('/^[0-9a-zA-Z\s]+$/', $name)) {
						...
						$query = "INSERT INTO Regions VALUES(NULL,'$name','$target_path','$thumb_path');";
						...
						echo "<p>Successfully added an Region</p>";
						include('addRegionForm.php');
						exit();	
					} else {
						echo "<p>There was an error uploading the file, please try again!</p>";
